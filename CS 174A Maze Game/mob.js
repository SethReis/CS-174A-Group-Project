export class Mob {
    constructor(startingPosition) {
        ...
        this.speed = 0.01; // Speed of movement (adjust as needed)
    ...
    move(wall_array) {
        ...
        // Check for collisions with walls using the wall_array
        let collided = false;
        for (let i = 0; i < wall_array.length; i++) {
            ...
            switch (this.direction) {
                case 'up':
                    mobLeft = nextX - this.size / 2;
                    mobRight = nextX + this.size / 2;
                ...
                case 'left':
                    ...
                    mobRight = nextX;
                    mobTop = nextZ - this.size / 2;
                    mobBottom = nextZ + this.size / 2;
                    break;
                case 'right':
                    mobLeft = nextX;
